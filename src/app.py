...
activities = {
    ...
    "Soccer Team": {
        "description": "Soccer training sessions and inter-school competitions",
    ...
    "Drama Society": {
        "description": "Acting workshops, script reading, and school performances",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["amelia@mergington.edu", "henry@mergington.edu"]
    },
    "Debate Club": {
        "description": "Develop argumentation and public speaking through debates",
